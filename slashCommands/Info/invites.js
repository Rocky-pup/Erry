...
let GuildSettings = client.settings.get(`${interaction.guild.id}`)
    ...
    try{
      ...
      interaction?.reply({ephemeral: true, embeds: [new Discord.MessageEmbed()
        .setAuthor(client.getAuthor(handlemsg(client.la[ls].cmds.info.invites.author, {usertag: user.tag}), user.displayAvatarURL({dynamic: true}), "https://dsc.gg/banditcamp"))
