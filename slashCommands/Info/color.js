...
let GuildSettings = client.settings.get(`${interaction.guild.id}`)
    ...
    let color = options.getString("color");
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:arrow:950884679114952715> **Name**', json.name, true)
        .addField("<:arrow:950884679114952715> **Hex**", json.hex, true)
        .addField("<:arrow:950884679114952715> **RGB**", json.rgb, true)
        .addField(`<:arrow:950884679114952715> **${client.la[ls].cmds.info.color.brightershade}**`, json.brightened, true)
