...
blues, oldgaming, pop, remixes, rock, strange-fruits-gaming
      */
      ...
      ["Chill Mix", "chill"], 
      ["Default Mix", "default"], 
      ["Rocky's spotify playlist", "rocky's-playlist"], 
      ["Gaming Mix", "gaming"], 
  ...
  //Chill
    ...
    //strange-fruits
       ...
       //metal
     //my
       if (args[0].toLowerCase().startsWith("rocky")) link = "https://open.spotify.com/playlist/70Z2lb2F2g2LXaBkcpxABM?si=16e58d38908749cb";
       //music storage
