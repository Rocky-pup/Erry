    ...
    try {
      ...
      if (customavatar) {
        let embed = new Discord.MessageEmbed()
          ...
          .addField("<:arrow:950884679114952715> WEBP", `[\`LINK\`](${customavatar.replace("png", "webp").replace("gif", "webp")})`, true)
          .setURL(customavatar)
        ...
        let embed = new MessageEmbed()
          ...
          .addField("<:arrow:950884679114952715> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
