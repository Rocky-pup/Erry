    ...
    if (message.author?.id != "913117505541775420")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only Rocky is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://dsc.gg/banditcamp), open a Ticket and ask for it!`)
        ]
      });
    try {
