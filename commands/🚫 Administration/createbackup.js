...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
        ...
        if(!message.guild.me.permissions.has(Discord.Permissions.FLAGS.ADMINISTRATOR)){
            return message.reply(":no_entry_sign: **I am missing the ADMINISTRATOR Permission!**")
        }
        ...
        if(owner.id != cmduser.id) {
            return message.reply(`:no_entry_sign: **You need to be the Owner of this Server!**`)
        }
