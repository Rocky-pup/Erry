    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Youtube-Poster', 'https://cdn.discordapp.com/emojis/950886430421418004.png?size=128', 'https://dsc.gg/banditcamp'))
      ...
      async function handle_the_picks(optionhandletype, SetupNumber, menuoptiondata) {
        switch (optionhandletype) {
          ...
          case "Edit Youtube Channel":{
            ...
            let MenuEmbed = new MessageEmbed()
              .setColor(es.color)
              .setAuthor('Youtube-Poster', 'https://cdn.discordapp.com/emojis/950886430421418004.png?size=128', 'https://dsc.gg/banditcamp')
