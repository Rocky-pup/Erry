  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    ...
    async function first_layer() {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Application Setup', 'https://cdn.discordapp.com/emojis/877653386747605032.png?size=96', 'https://dsc.gg/banditcamp'))
    ...
    async function second_layer(SetupNumber, menuoptiondata) {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor(SetupNumber + " Apply Setup", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/incoming-envelope_1f4e8.png", "https://dsc.gg/banditcamp"))
      ...
      try {
        ...
        switch (args) {
          ...
          case "temprole":
            ...
            break;
          case "addquestion": {
            if (await apply_for_here.get(`${message.guild.id}.${pre}.applytype`) == `modal`) return message.reply("Not ready for modal");
            message.reply({
              embeds: [new Discord.MessageEmbed()
                .setFooter(client.getFooter(es))
                .setColor(es.color)
