                  ...
                  try {
                    ...
                    if(a.map(d => d.id).includes(channel.id))
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`:no_entry_sign: This Channel is already Setupped!`)
                    ...
                    if(!time || isNaN(time))
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`:no_entry_sign: Invalid Input | Time wrong`)
                    ...
                    if(time > 60*60 || time < 3)
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`:no_entry_sign: Time out of Range!`)
              ...
              .then(collected => {
                ...
                if (channel) {
                  try {
                    ...
                    if(!a.map(d => d.id).includes(channel.id))
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`:no_entry_sign: This Channel has not been Setup yet!`)
                      .setColor(es.color)
                      .setFooter(client.getFooter(es))
                    ]});
