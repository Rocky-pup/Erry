      ...
      async function handle_the_picks(optionhandletype, SetupNumber, menuoptiondata) {
        switch (optionhandletype) {          
                  ...
                  async function handle_the_picks_3(optionhandletype, SetupNumber, menuoptiondata){
                    switch (optionhandletype) {
                      ...
                      case `Frame Color`:{
                        ...
                        //Once the Collections ended edit the menu message
                        collector.on('end', collected => {
                          tempmsg.edit({embeds: [tempmsg.embeds[0].setDescription(`~~${tempmsg.embeds[0].description}~~`)], components: [], content: `${collected && collected.first() && collected.first().customId ? `:white_check_mark: **Selected the \`${collected.first().customId}\` Color**` : "❌ **NOTHING SELECTED - CANCELLED**" }`})
                        });
                        //Menu Collections
          ...
          case `Test Welcome`:{
            ...
            let invitemessage = `Invited by ${member.user.tag ? `**${member.user.tag}**` : `<@${member.user.id}>`}\n<:Like:950879167380090880> **X Invites**\n[<:joines:950878825254883378> X Joins | <:leaves:950879337454895134> X Leaves | :no_entry_sign: X Fakes]`
            if(welcome){
            ...
            async function dm_msg_autoimg(member) {
              ...
              //member roles add on welcome every single role
                ...
                if (client.settings.get(member.guild.id, "welcome.framedm")) {
                  ...
                  if (framecolor == "WHITE") framecolor = "#25FA6C";
                ...
                if (fillcolors == "WHITE") framecolor = "#25FA6C";
            ...
            async function msg_autoimg(member) {
              ...
              try {
                ...
                const welcomeembed = new Discord.MessageEmbed()
                  ...
                  if (fillcolor == "WHITE") framecolor = "#25FA6C";
