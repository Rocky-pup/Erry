  ...
  async function message(member) {
    ...
    async function dm_msg_autoimg(member) {
      try {
        ...
        if (fillcolors == "WHITE") fillcolor == "#25FA6C"
    ...
    async function msg_autoimg(member) {
      try {
        ...
        if (fillcolor == "WHITE") fillcolor == "#25FA6C";
