        ...
        await msgs.forEach(async msg => {
            ...
            if(msg.type == "DEFAULT"){
              ...
              if (msg.reactions && msg.reactions.cache.size > 0){
                ...
                for await (const reaction of msg.reactions.cache.map(this_Code_is_by_Rocky => this_Code_is_by_Rocky)){                      
