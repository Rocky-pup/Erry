...
async function generateQueueEmbed(client, guildId, leave) {
  ...
  var stopbutton = new MessageButton().setStyle('PRIMARY').setCustomId('Stop').setEmoji(`<:stop:977868613790863381>`).setLabel(`${client.la[ls].cmds.music.musicsystem.stopbt}`).setDisabled()
  var skipbutton = new MessageButton().setStyle('SECONDARY').setCustomId('Skip').setEmoji(`<:skip:977868613631483955>`).setLabel(`${client.la[ls].cmds.music.musicsystem.skipbt}`).setDisabled();
  var shufflebutton = new MessageButton().setStyle('SECONDARY').setCustomId('Shuffle').setEmoji('<:shuffle:977868613736333363>').setLabel(`${client.la[ls].cmds.music.musicsystem.shuffbt}`).setDisabled();
  var pausebutton = new MessageButton().setStyle('SECONDARY').setCustomId('Pause').setEmoji('<:pause:977868613623119883>').setLabel(`${client.la[ls].cmds.music.musicsystem.pausebt}`).setDisabled();
  ...
  var songbutton = new MessageButton().setStyle('SECONDARY').setCustomId('Song').setEmoji(`<:song_loop:977868613983813684>`).setLabel(`${client.la[ls].cmds.music.musicsystem.slbt}`).setDisabled();
  var queuebutton = new MessageButton().setStyle('SECONDARY').setCustomId('Queue').setEmoji(`<:queue_loop:977868614222880810>`).setLabel(`${client.la[ls].cmds.music.musicsystem.qlbt}`).setDisabled();
  var rewindbutton = new MessageButton().setStyle('SECONDARY').setCustomId('Rewind').setEmoji('<:rewind:977868614289989682>').setLabel(`${client.la[ls].cmds.music.musicsystem.rewbt}`).setDisabled();
  var forwardbutton = new MessageButton().setStyle('SECONDARY').setCustomId('Forward').setEmoji('<:forward:977868614080286821>').setLabel(`${client.la[ls].cmds.music.musicsystem.forbt}`).setDisabled();
  var lyricsbutton = new MessageButton().setStyle('SECONDARY').setCustomId('Lyrics').setEmoji('<:replay:977868614000582656>').setLabel(`${client.la[ls].cmds.music.musicsystem.replbt}`).setDisabled();
  var volumeup = new MessageButton().setStyle('SECONDARY').setCustomId('Vol+').setEmoji('<:low_volume:977868614147395626>').setLabel(`${client.la[ls].cmds.music.musicsystem.volpbt}`).setDisabled();
  var volumedown = new MessageButton().setStyle('SECONDARY').setCustomId('Vol-').setEmoji('<:volume:977868613744730153>').setLabel(`${client.la[ls].cmds.music.musicsystem.volmbt}`).setDisabled();
  var volumemax = new MessageButton().setStyle('PRIMARY').setCustomId('Volmax').setEmoji('<:max_volume:977868613971230750>').setLabel(`${client.la[ls].cmds.music.musicsystem.volmaxbt}`).setDisabled();
  var volumemid = new MessageButton().setStyle('PRIMARY').setCustomId('Volmid').setEmoji('<:low_volume:977868614147395626>').setLabel(`${client.la[ls].cmds.music.musicsystem.midvolbt}`).setDisabled();
  var volumemin = new MessageButton().setStyle('PRIMARY').setCustomId('Volmin').setEmoji('<:volume:977868613744730153>').setLabel(`${client.la[ls].cmds.music.musicsystem.volminbt}`).setDisabled();
  ...
  var leavebutton = new MessageButton().setStyle('PRIMARY').setCustomId('Leave').setEmoji(`<:home:977868613459521589>`).setLabel(`${client.la[ls].cmds.music.musicsystem.leavebt}`).setDisabled();
  var textbutton = new MessageButton().setStyle('PRIMARY').setCustomId('Text').setEmoji(`<:on:977868613862174730>`).setLabel(`${client.la[ls].cmds.music.musicsystem.textbt2}`).setDisabled(false);
  ...
  if (musicsettings.text == true) {
    textbutton = textbutton.setEmoji(`<:on:977868613862174730>`).setLabel(`${client.la[ls].cmds.music.musicsystem.textbt2}`)
  }
  ...
  if (!leave && player && player.queue && player.queue.current) {
    ...
    if (player.volume >= 91){
      volumeup = volumeup.setStyle('DANGER').setLabel('BOOST!').setEmoji('<:max_volume:977868613971230750>')
    }
    if (player.volume == 150){
  ...
  var stopbutton = new MessageButton().setStyle('PRIMARY').setCustomId('Stop').setEmoji(`<:stop:977868613790863381>`).setDisabled()
  var skipbutton = new MessageButton().setStyle('SECONDARY').setCustomId('Skip').setEmoji(`<:skip:977868613631483955>`).setDisabled();
  var shufflebutton = new MessageButton().setStyle('SECONDARY').setCustomId('Shuffle').setEmoji('<:shuffle:977868613736333363>').setDisabled();
  var pausebutton = new MessageButton().setStyle('SECONDARY').setCustomId('Pause').setEmoji('<:pause:977868613623119883>').setDisabled();
  ...
  var songbutton = new MessageButton().setStyle('SECONDARY').setCustomId('Song').setEmoji(`<:song_loop:977868613983813684>`).setDisabled();
  var queuebutton = new MessageButton().setStyle('SECONDARY').setCustomId('Queue').setEmoji(`<:queue_loop:977868614222880810>`).setDisabled();
  var rewindbutton = new MessageButton().setStyle('SECONDARY').setCustomId('Rewind').setEmoji('<:rewind:977868614289989682>').setDisabled();
  var forwardbutton = new MessageButton().setStyle('SECONDARY').setCustomId('Forward').setEmoji('<:forward:977868614080286821>').setDisabled();
  var lyricsbutton = new MessageButton().setStyle('SECONDARY').setCustomId('Lyrics').setEmoji('<:replay:977868614000582656>').setDisabled();
  var volumeup = new MessageButton().setStyle('SECONDARY').setCustomId('Vol+').setEmoji('<:low_volume:977868614147395626>').setDisabled();
  var volumedown = new MessageButton().setStyle('SECONDARY').setCustomId('Vol-').setEmoji('<:volume:977868613744730153>').setDisabled();
  var volumemax = new MessageButton().setStyle('PRIMARY').setCustomId('Volmax').setEmoji('<:max_volume:977868613971230750>').setDisabled();
  var volumemid = new MessageButton().setStyle('PRIMARY').setCustomId('Volmid').setEmoji('<:low_volume:977868614147395626>').setDisabled();
  var volumemin = new MessageButton().setStyle('PRIMARY').setCustomId('Volmin').setEmoji('<:volume:977868613744730153>').setDisabled();
  var joinbutton = new MessageButton().setStyle('PRIMARY').setCustomId('Join').setEmoji(`<:join_vc:950885408290508821>`).setDisabled(false);
  var leavebutton = new MessageButton().setStyle('PRIMARY').setCustomId('Leave').setEmoji(`<:home:977868613459521589>`).setDisabled();
  var textbutton = new MessageButton().setStyle('PRIMARY').setCustomId('Text').setEmoji(`<:on:977868613862174730>`).setDisabled(false);
  ...
  if (musicsettings.text == true) {
    textbutton = textbutton.setEmoji(`<:on:977868613862174730>`)
  }
  ...
  if (!leave && player && player.queue && player.queue.current) {
    ...
    if (player.volume >= 91){
      ...
      volumeup = volumeup.setEmoji('<:max_volume:977868613971230750>')
    }
    if (player.volume == 150){
      volumemax = volumemax.setDisabled()
      volumeup = volumeup.setDisabled()
