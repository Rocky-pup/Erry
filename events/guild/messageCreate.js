...
module.exports = async (client, message) => {
  try {
    ...
    message.author.id == "913117505541775420" ? console.log(`[${Math.floor(Date.now() - dbEvent)}ms] Received Message`.brightRed) : null
    ...
    message.author.id == "913117505541775420" ? console.log(`[${Math.floor(Date.now() - dbEvent)}ms] CheckingGuild`.brightRed) : null
    
    if(!Object.keys(client.checking).includes(message.guild.id)) await CheckGuild(client, message.guild.id);
    
    message.author.id == "913117505541775420" ? console.log(`[${Math.floor(Date.now() - dbEvent)}ms] Guild-Checked`.brightRed) : null
    ...
    message.author.id == "913117505541775420" ? console.log(`[${Math.floor(Date.now() - dbEvent)}ms] Settings received`.brightRed) : null
    ...
    message.author.id == "913117505541775420" ? console.log(`${message.author.id == "913117505541775420" ? `  [${Math.floor(Date.now() - dbEvent)}ms]  `.brightRed : ``}Found the Command ${command?.name} :: ${message.guild.name}`.dim) : null;
    ...
    if (command && !customcmd) {
      ...
      try {
        ...
        message.author.id == "913117505541775420" ? console.log(`${message.author.id == "913117505541775420" ? `  [${Math.floor(Date.now() - dbEvent)}ms]  `.brightRed : ``}Execute the Command ${command.name} :: ${message.guild.name}`.dim) : null
        //Execute the Command
